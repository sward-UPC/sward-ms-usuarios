...
def _notif_response(n: Notificacion) -> NotificacionResponse:
...
@router.get("", response_model=NotificacionesListResponse, summary="Notificaciones del usuario autenticado")
...
@router.post("/{notif_id}/read", response_model=OkResponse, summary="Marca una notificación como leída")
...
@router.post("/read-all", response_model=ReadAllResponse, summary="Marca todas como leídas")
async def marcar_todas_leidas(
    ...
    return ReadAllResponse(ok=True, actualizadas=n)


@router.delete("/{notif_id}", response_model=OkResponse, summary="Elimina una notificación")
