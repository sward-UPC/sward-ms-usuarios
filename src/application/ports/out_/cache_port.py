...
class CachePort(ABC):
    ...
    # El estado BLOQUEADO lo puede poner un administrador o el propio login tras
    # varios intentos fallidos. Solo el segundo debe levantarse cuando la persona
    # recupera su cuenta, así que se deja constancia de cuál fue.
    @abstractmethod
